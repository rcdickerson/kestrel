...
if( o2_getCardSet > o1_getCardSet ) {
ret_2 = 1;
} else {
if( o2_getCardSet < o1_getCardSet ) {
ret_2 = -1;
} else {
if( o2_getCardRarity < o1_getCardRarity ) {
ret_2 = 1;
} else {
if( o2_getCardRarity > o1_getCardRarity ) {
ret_2 = -1;
} else {
if( o2_getCardId > o1_getCardId ) {
ret_2 = 1;
} else {
if( o2_getCardId < o1_getCardId ) {
ret_2 = -1;
} else {
ret_2 = o2_cardType - o1_cardType;
}
}
}
}
