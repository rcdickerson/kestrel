...
void main() {
  __VERIFIER_assume((left_o1_contains_id == right_o2_contains_id) && ((left_o1_get_id == right_o2_get_id) && ((left_o1_contains_id == right_o2_contains_id) && (left_o1_get_id == right_o2_get_id))));
  int l_ret = -999;
  int r_ret = -999;
