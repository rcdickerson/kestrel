...
start:
  ...
  call void @llvm.dbg.declare(metadata ptr %val.dbg.spill, metadata !19, metadata !DIExpression()), !dbg !29
  ...
  call void @llvm.dbg.declare(metadata ptr %a_size.dbg.spill, metadata !20, metadata !DIExpression()), !dbg !32
...
bb5:                                              ; preds = %bb3, %bb1
  ...
  call void @llvm.dbg.declare(metadata ptr %len.dbg.spill, metadata !25, metadata !DIExpression()), !dbg !37
...
bb3:                                              ; preds = %bb2
  %0 = getelementptr inbounds i32, ptr %a, i64 %_9, !dbg !41
...
bb6:                                              ; preds = %bb5
  %2 = getelementptr inbounds i32, ptr %a, i64 %_13, !dbg !39
...
!8 = !DIFile(filename: "llvm-examples/array-insert/right.rs", directory: "/kestrel", checksumkind: CSK_MD5, checksum: "124fa5f44a15c8a1597f76efa1f89b83")
