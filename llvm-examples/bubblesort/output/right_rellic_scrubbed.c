void right(void *a) {
    ...
    *(unsigned long *)(&i) = 0;
    ...
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 >= 10) {
    ...
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val7 < 10 && val9 >= 10) {
        _RNvNtCscI6d9CVNmLh_4core9panicking18panic_bounds_check(val9, 10, &alloc_a026c78e675b1169ca6570e96453f0ba);
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val7 < 10) {
        val10 = *(unsigned long *)(&j);
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val10 >= 10 && val7 < 10) {
        _RNvNtCscI6d9CVNmLh_4core9panicking18panic_bounds_check(val10, 10, &alloc_991cfbf1566089e55fc7fedefbf4d17b);
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val7 < 10 && val10 < 10) {
        ((float *)a)[val10] = ((float *)a)[val9];
        val11 = *(unsigned long *)(&j) - 1;
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && val11 >= 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val7 < 10 && val10 < 10) {
        _RNvNtCscI6d9CVNmLh_4core9panicking18panic_bounds_check(val11, 10, &alloc_a660e85f91318953292432dd99f84179);
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && val11 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val7 < 10 && val10 < 10) {
        ((float *)a)[val11] = val8;
    }
    if (*(unsigned long *)(&i) < 10 && val5 < 10 && *(unsigned long *)(&j) > *(unsigned long *)(&i) && val6 < 10 && (((float *)a)[val5] <= ((float *)a)[val6] || val11 < 10 && ((float *)a)[val5] > ((float *)a)[val6] && val9 < 10 && val7 < 10 && val10 < 10)) {
