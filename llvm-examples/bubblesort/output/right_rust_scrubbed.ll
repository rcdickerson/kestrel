...
start:
  ...
  call void @llvm.dbg.declare(metadata ptr %a.dbg.spill, metadata !18, metadata !DIExpression()), !dbg !29
  call void @llvm.dbg.declare(metadata ptr %i, metadata !22, metadata !DIExpression()), !dbg !30
  call void @llvm.dbg.declare(metadata ptr %j, metadata !24, metadata !DIExpression()), !dbg !31
  store i64 10, ptr %n.dbg.spill, align 8, !dbg !32
  call void @llvm.dbg.declare(metadata ptr %n.dbg.spill, metadata !19, metadata !DIExpression()), !dbg !33
...
bb5:                                              ; preds = %bb4
  %1 = getelementptr inbounds float, ptr %a, i64 %_12, !dbg !46
...
bb6:                                              ; preds = %bb5
  %2 = getelementptr inbounds float, ptr %a, i64 %_16, !dbg !48
...
bb8:                                              ; preds = %bb7
  %4 = getelementptr inbounds float, ptr %a, i64 %_19, !dbg !52
  %temp = load float, ptr %4, align 4, !dbg !52
  store float %temp, ptr %temp.dbg.spill, align 4, !dbg !52
  call void @llvm.dbg.declare(metadata ptr %temp.dbg.spill, metadata !26, metadata !DIExpression()), !dbg !53
...
bb9:                                              ; preds = %bb8
  %5 = getelementptr inbounds float, ptr %a, i64 %_22, !dbg !55
...
bb10:                                             ; preds = %bb9
  %6 = getelementptr inbounds float, ptr %a, i64 %_25, !dbg !57
...
bb11:                                             ; preds = %bb10
  %7 = getelementptr inbounds float, ptr %a, i64 %_27, !dbg !59
...
!8 = !DIFile(filename: "llvm-examples/bubblesort/right.rs", directory: "/kestrel", checksumkind: CSK_MD5, checksum: "9b52e2138b28c3c17c8252106797ce7a")
