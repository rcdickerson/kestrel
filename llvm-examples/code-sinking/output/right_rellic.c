...
void right(void *a) {
    ...
    *(unsigned long *)(&maxi) = 0UL;
    ...
    if (*(unsigned long *)(&j) < 10UL && (val7 < 11UL || (int)(*(unsigned int *)(&max)) >= (int)(((unsigned int *)a)[val6])) && val6 < 11UL && *(unsigned long *)(&j) == 10UL) {
        val8 = ((unsigned int *)a)[10UL];
        *(unsigned int *)(&t) = val8;
        ((unsigned int *)a)[10UL] = *(unsigned int *)(&max);
        val9 = *(unsigned long *)(&maxi);
    }
    if (*(unsigned long *)(&j) < 10UL && (val7 < 11UL || (int)(*(unsigned int *)(&max)) >= (int)(((unsigned int *)a)[val6])) && val6 < 11UL && val9 >= 11UL && *(unsigned long *)(&j) == 10UL) {
        _RNvNtCscI6d9CVNmLh_4core9panicking18panic_bounds_check(val9, 11UL, &alloc_f8b2f46ae7d9d9573fbd43ab55b46be9);
    }
    if (*(unsigned long *)(&j) < 10UL && (val7 < 11UL || (int)(*(unsigned int *)(&max)) >= (int)(((unsigned int *)a)[val6])) && val6 < 11UL && *(unsigned long *)(&j) == 10UL && val9 < 11UL) {
