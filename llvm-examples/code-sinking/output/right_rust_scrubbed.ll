...
start:
  ...
  call void @llvm.dbg.declare(metadata ptr %j, metadata !22, metadata !DIExpression()), !dbg !32
  call void @llvm.dbg.declare(metadata ptr %max, metadata !24, metadata !DIExpression()), !dbg !33
  call void @llvm.dbg.declare(metadata ptr %maxi, metadata !26, metadata !DIExpression()), !dbg !34
  store i64 10, ptr %n.dbg.spill, align 8, !dbg !35
  call void @llvm.dbg.declare(metadata ptr %n.dbg.spill, metadata !19, metadata !DIExpression()), !dbg !36
...
bb3:                                              ; preds = %bb2
  %0 = getelementptr inbounds i32, ptr %a, i64 0, !dbg !48
...
bb6:                                              ; preds = %bb5
  %1 = getelementptr inbounds i32, ptr %a, i64 %_16, !dbg !47
...
bb8:                                              ; preds = %bb7
  %2 = getelementptr inbounds i32, ptr %a, i64 %_19, !dbg !54
...
bb10:                                             ; preds = %bb9
  %4 = getelementptr inbounds i32, ptr %a, i64 10, !dbg !61
  %t = load i32, ptr %4, align 4, !dbg !61
  store i32 %t, ptr %t.dbg.spill, align 4, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %t.dbg.spill, metadata !28, metadata !DIExpression()), !dbg !62
  %_26 = load i32, ptr %max, align 4, !dbg !63
  %5 = getelementptr inbounds i32, ptr %a, i64 10, !dbg !64
...
bb13:                                             ; preds = %bb10
  %6 = getelementptr inbounds i32, ptr %a, i64 %_28, !dbg !66
...
!8 = !DIFile(filename: "llvm-examples/code-sinking/right.rs", directory: "/kestrel", checksumkind: CSK_MD5, checksum: "884f0a0626d83d29e03c17f2d6d56c36")
