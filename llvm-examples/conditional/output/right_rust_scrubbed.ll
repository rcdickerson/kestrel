...
start:
  ...
  call void @llvm.dbg.declare(metadata ptr %age.dbg.spill, metadata !14, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %ret_val, metadata !15, metadata !DIExpression()), !dbg !19
