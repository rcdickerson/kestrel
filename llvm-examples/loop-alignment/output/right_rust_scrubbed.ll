...
start:
  ...
  call void @llvm.dbg.declare(metadata ptr %a.dbg.spill, metadata !18, metadata !DIExpression()), !dbg !28
  store ptr %b, ptr %b.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata ptr %b.dbg.spill, metadata !19, metadata !DIExpression()), !dbg !29
  call void @llvm.dbg.declare(metadata ptr %j, metadata !23, metadata !DIExpression()), !dbg !30
  call void @llvm.dbg.declare(metadata ptr %d, metadata !25, metadata !DIExpression()), !dbg !31
  store i64 20, ptr %n.dbg.spill, align 8, !dbg !32
  call void @llvm.dbg.declare(metadata ptr %n.dbg.spill, metadata !20, metadata !DIExpression()), !dbg !33
  store i64 1, ptr %j, align 8, !dbg !34
  call void @llvm.memset.p0.i64(ptr align 4 %d, i8 0, i64 84, i1 false), !dbg !35
  %0 = getelementptr inbounds i32, ptr %b, i64 0, !dbg !36
  %_6 = load i32, ptr %0, align 4, !dbg !36
  %1 = getelementptr inbounds i32, ptr %d, i64 1, !dbg !37
...
bb9:                                              ; preds = %bb3
  %2 = getelementptr inbounds i32, ptr %a, i64 20, !dbg !40
  %_26 = load i32, ptr %2, align 4, !dbg !40
  %3 = getelementptr inbounds i32, ptr %b, i64 20, !dbg !41
...
bb5:                                              ; preds = %bb4
  %4 = getelementptr inbounds i32, ptr %a, i64 %_15, !dbg !45
...
bb6:                                              ; preds = %bb5
  %5 = getelementptr inbounds i32, ptr %b, i64 %_17, !dbg !47
...
bb7:                                              ; preds = %bb6
  %6 = getelementptr inbounds i32, ptr %b, i64 %_20, !dbg !49
...
bb8:                                              ; preds = %bb7
  %7 = getelementptr inbounds i32, ptr %d, i64 %_22, !dbg !51
...
!8 = !DIFile(filename: "llvm-examples/loop-alignment/right.rs", directory: "/kestrel", checksumkind: CSK_MD5, checksum: "bf0c0516614580c1674bd35c39e77585")
