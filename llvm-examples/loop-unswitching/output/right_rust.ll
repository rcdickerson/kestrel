...
start:
  ...
  store ptr %b, ptr %b.dbg.spill, align 8
    #dbg_declare(ptr %b.dbg.spill, !19, !DIExpression(), !32)
  store ptr %c, ptr %c.dbg.spill, align 8
    #dbg_declare(ptr %c.dbg.spill, !20, !DIExpression(), !33)
  store i32 %k, ptr %k.dbg.spill, align 4
    #dbg_declare(ptr %k.dbg.spill, !21, !DIExpression(), !34)
  store i32 %x, ptr %x.dbg.spill, align 4
    #dbg_declare(ptr %x.dbg.spill, !22, !DIExpression(), !35)
    #dbg_declare(ptr %j, !26, !DIExpression(), !36)
    #dbg_declare(ptr %j1, !28, !DIExpression(), !37)
  store i64 10, ptr %n.dbg.spill, align 8, !dbg !38
    #dbg_declare(ptr %n.dbg.spill, !23, !DIExpression(), !39)
...
bb12:                                             ; preds = %bb11
  %0 = getelementptr inbounds nuw i32, ptr %a, i64 %_29, !dbg !48
...
bb13:                                             ; preds = %bb12
  %1 = getelementptr inbounds nuw i32, ptr %a, i64 %_31, !dbg !50
...
bb14:                                             ; preds = %bb13
  %3 = getelementptr inbounds nuw i32, ptr %a, i64 %_34, !dbg !52
...
bb15:                                             ; preds = %bb14
  %4 = getelementptr inbounds nuw i32, ptr %b, i64 %_38, !dbg !54
...
bb16:                                             ; preds = %bb15
  %5 = getelementptr inbounds nuw i32, ptr %b, i64 %_41, !dbg !56
...
bb4:                                              ; preds = %bb3
  %8 = getelementptr inbounds nuw i32, ptr %a, i64 %_12, !dbg !61
...
bb5:                                              ; preds = %bb4
  %9 = getelementptr inbounds nuw i32, ptr %a, i64 %_14, !dbg !63
...
bb6:                                              ; preds = %bb5
  %11 = getelementptr inbounds nuw i32, ptr %a, i64 %_17, !dbg !65
...
bb7:                                              ; preds = %bb6
  %12 = getelementptr inbounds nuw i32, ptr %c, i64 %_20, !dbg !67
...
bb8:                                              ; preds = %bb7
  %13 = getelementptr inbounds nuw i32, ptr %b, i64 %_22, !dbg !69
