...
start:
  ...
  store i32 %x, ptr %x.dbg.spill, align 4
    #dbg_declare(ptr %x.dbg.spill, !14, !DIExpression(), !22)
    #dbg_declare(ptr %x.dbg.spill, !17, !DIExpression(), !23)
    #dbg_declare(ptr %y, !15, !DIExpression(), !24)
    #dbg_declare(ptr %i, !19, !DIExpression(), !25)
