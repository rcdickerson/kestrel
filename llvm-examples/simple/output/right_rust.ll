...
start:
  ...
  store i32 %x, ptr %x.dbg.spill, align 4
    #dbg_declare(ptr %x.dbg.spill, !14, !DIExpression(), !18)
  %ret_val = add i32 %x, 1, !dbg !19
  store i32 %ret_val, ptr %ret_val.dbg.spill, align 4, !dbg !19
    #dbg_declare(ptr %ret_val.dbg.spill, !15, !DIExpression(), !20)
  ret void, !dbg !21
}
...
!6 = !DIFile(filename: "llvm-examples/verified/simple/right.rs/@/right.59b4154acb9ecd45-cgu.0", directory: "/kestrel")
...
!8 = !DIFile(filename: "llvm-examples/verified/simple/right.rs", directory: "/kestrel", checksumkind: CSK_MD5, checksum: "19069e79a2a65fbac015d79d6b7332b0")
