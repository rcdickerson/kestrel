(set-info :original "./results/chc/bytecode/antonopoulos/sa/array-insert.bc")
(set-info :authors "SeaHorn v.14.0.0-rc0")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry ((Array Int Int) (Array Int Int) Int ))
(declare-rel main@.lr.ph7 (Int Int (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int ))
(declare-rel main@.lr.ph (Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int Int Int ))
(declare-rel main@_30 (Int Int Int Int (Array Int Int) Int Int ))
(declare-rel main@_35 (Int Int Int ))
...
(declare-var |tuple(main@_23_0, main@.critedge1.i_0)| Bool )
...
(rule (let ((a!1 (and (main@entry main@%sm7_0 main@%sm8_0 @arb_int_0)
                ...
                main@%_0_0
                (= main@%_1_0 (= main@%loop.bound1_0 11))
                main@%_1_0
...
(rule (let ((a!1 (=> main@.critedge.i_0
               (= main@%_20_0 (+ @A_right_0 (* 0 44) (* 0 4))))))
(let ((a!2 (and (main@entry main@%sm7_0 main@%sm8_0 @arb_int_0)
                true
                (= main@%sm_0 main@%sm8_0)
                (= main@%sm4_0 main@%sm7_0)
                (= main@%_0_0 (= main@%loop.bound_0 11))
                ...
                a!1
                (=> main@.critedge.i_0 (or (<= @A_right_0 0) (> main@%_20_0 0)))
                (=> main@.critedge.i_0
                    (= main@%_21_0 (select main@%sm4_0 main@%_20_0)))
                (=> main@.critedge.i_0
                    (= main@%_22_0 (< main@%_21_0 main@%_7_0)))
                (=> main@.lr.ph_0 (and main@.lr.ph_0 main@.critedge.i_0))
                (=> (and main@.lr.ph_0 main@.critedge.i_0) main@%_22_0)
                (=> (and main@.lr.ph_0 main@.critedge.i_0) (= main@%.0.i13_0 0))
                (=> (and main@.lr.ph_0 main@.critedge.i_0)
                    (= main@%.0.i13_1 main@%.0.i13_0))
                main@.lr.ph_0)))
  (=> a!2
      (main@.lr.ph main@%loop.bound_0
                   @A_right_0
                   main@%sm4_0
                   main@%_7_0
                   main@%loop.bound1_0
...
(rule (let ((a!1 (= main@%_11_0 (+ (+ @A_left_0 (* 0 44)) (* 0 4))))
      (a!2 (=> main@.critedge.i_0
               (= main@%_20_0 (+ @A_right_0 (* 0 44) (* 0 4)))))
      (a!3 (= main@%_29_0 (+ (+ @A_left_0 (* 0 44)) (* main@%.02.i.lcssa_1 4)))))
(let ((a!4 (and (main@entry main@%sm7_0 main@%sm8_0 @arb_int_0)
                true
                (= main@%sm_0 main@%sm8_0)
                (= main@%sm4_0 main@%sm7_0)
                (= main@%_0_0 (= main@%loop.bound_0 11))
                ...
                (=> main@.critedge.i_0
                    (= main@%_22_0 (< main@%_21_0 main@%_7_0)))
                (=> main@.critedge1.i_0
                    (and main@.critedge1.i_0 main@.critedge.i_0))
                (=> (and main@.critedge1.i_0 main@.critedge.i_0)
                    (not main@%_22_0))
                (=> (and main@.critedge1.i_0 main@.critedge.i_0)
                    (= main@%.0.i.lcssa_0 0))
                ...
                (=> main@.critedge1.i_0 a!3)
                (=> main@.critedge1.i_0 (or (<= @A_left_0 0) (> main@%_29_0 0)))
                (=> main@.critedge1.i_0 (> @A_left_0 0))
                (=> main@.critedge1.i_0
                    (= main@%sm5_0 (store main@%sm_0 main@%_29_0 main@%_5_0)))
                (=> main@_30_0 (and main@_30_0 main@.critedge1.i_0))
                (=> (and main@_30_0 main@.critedge1.i_0)
                    (= main@%.13.i_0 main@%.02.i.lcssa_1))
                (=> (and main@_30_0 main@.critedge1.i_0)
                    (= main@%.13.i_1 main@%.13.i_0))
                main@_30_0)))
  (=> a!4
      (main@_30 main@%.13.i_1
                main@%loop.bound_0
                @A_right_0
                main@%.0.i.lcssa_1
                main@%sm4_0
...
(rule (let ((a!1 (= main@%_15_0 (+ (+ @A_left_0 (* 0 44)) (* main@%_18_0 4))))
      (a!2 (=> main@.critedge.i_0
               (= main@%_20_0 (+ @A_right_0 (* 0 44) (* 0 4)))))
      (a!3 (= main@%_29_0 (+ (+ @A_left_0 (* 0 44)) (* main@%.02.i.lcssa_2 4)))))
(let ((a!4 (and (main@.lr.ph7 main@%loop.bound_0
                              @A_right_0
                              main@%sm4_0
                              main@%_7_0
                              main@%loop.bound1_0
...
(rule (let ((a!1 (=> main@_23_0
               (= main@%_24_0 (+ @A_right_0 (* 0 44) (* main@%_27_0 4))))))
(let ((a!2 (and (main@.lr.ph main@%loop.bound_0
                             @A_right_0
                             main@%sm4_0
                             main@%_7_0
                             main@%loop.bound1_0
                             ...
                             main@%loop.bound2_0)
                true
                (= main@%_27_0 (+ main@%.0.i13_0 1))
                (= main@%_28_0 (< main@%.0.i13_0 main@%loop.bound2_0))
                (=> main@_23_0 (and main@_23_0 main@.lr.ph_0))
                (=> (and main@_23_0 main@.lr.ph_0) main@%_28_0)
                a!1
                (=> main@_23_0 (or (<= @A_right_0 0) (> main@%_24_0 0)))
                (=> main@_23_0 (> @A_right_0 0))
                (=> main@_23_0 (= main@%_25_0 (select main@%sm4_0 main@%_24_0)))
                (=> main@_23_0 (= main@%_26_0 (< main@%_25_0 main@%_7_0)))
                (=> main@.lr.ph_1 (and main@.lr.ph_1 main@_23_0))
                (=> (and main@.lr.ph_1 main@_23_0) main@%_26_0)
                (=> (and main@.lr.ph_1 main@_23_0)
                    (= main@%.0.i13_1 main@%_27_0))
                (=> (and main@.lr.ph_1 main@_23_0)
...
(rule (let ((a!1 (=> main@_23_0
               (= main@%_24_0 (+ @A_right_0 (* 0 44) (* main@%_27_0 4)))))
      (a!2 (=> main@.critedge1.i_0
               (= main@%_29_0 (+ @A_left_0 (* 0 44) (* main@%.02.i.lcssa_0 4))))))
(let ((a!3 (and (main@.lr.ph main@%loop.bound_0
                             @A_right_0
                             main@%sm4_0
                             main@%_7_0
                             main@%loop.bound1_0
                ...
                (=> |tuple(main@_23_0, main@.critedge1.i_0)| main@_23_0)
                (=> main@.critedge1.i_0
                    (or |tuple(main@.lr.ph_0, main@.critedge1.i_0)|
                        |tuple(main@_23_0, main@.critedge1.i_0)|))
                (=> |tuple(main@.lr.ph_0, main@.critedge1.i_0)|
                    (not main@%_28_0))
                (=> |tuple(main@_23_0, main@.critedge1.i_0)| (not main@%_26_0))
                (=> |tuple(main@.lr.ph_0, main@.critedge1.i_0)|
                    (= main@%.0.i.lcssa_0 main@%_27_0))
                (=> |tuple(main@_23_0, main@.critedge1.i_0)|
                    (= main@%.0.i.lcssa_1 main@%_27_0))
                (=> |tuple(main@.lr.ph_0, main@.critedge1.i_0)|
...
(rule (=> (and (main@_30 main@%.13.i_0
                   ...
                   main@%loop.bound1_0)
         true
         (= main@%_31_0 (< main@%.13.i_0 main@%loop.bound1_0))
         (= main@%_32_0 (+ main@%.13.i_0 1))
         (=> main@_30_1 (and main@_30_1 main@_30_0))
         (=> (and main@_30_1 main@_30_0) main@%_31_0)
         (=> (and main@_30_1 main@_30_0) (= main@%.13.i_1 main@%_32_0))
         (=> (and main@_30_1 main@_30_0) (= main@%.13.i_2 main@%.13.i_1))
         main@_30_1)
    (main@_30 main@%.13.i_2
              main@%loop.bound_0
              @A_right_0
              main@%.0.i.lcssa_0
              main@%sm4_0
...
(rule (let ((a!1 (=> main@_33_0
               (= main@%_34_0 (+ @A_right_0 (* 0 44) (* main@%.0.i.lcssa_0 4))))))
(let ((a!2 (and (main@_30 main@%.13.i_0
                          main@%loop.bound_0
                          @A_right_0
                          main@%.0.i.lcssa_0
                          main@%sm4_0
                ...
                (=> (and main@_33_0 main@_30_0) (not main@%_31_0))
                a!1
                (=> main@_33_0 (or (<= @A_right_0 0) (> main@%_34_0 0)))
                (=> main@_33_0 (> @A_right_0 0))
                (=> main@_33_0
                    (= main@%sm6_0 (store main@%sm4_0 main@%_34_0 main@%_7_0)))
                (=> main@_35_0 (and main@_35_0 main@_33_0))
                (=> (and main@_35_0 main@_33_0)
                    (= main@%.1.i_0 main@%.0.i.lcssa_0))
                (=> (and main@_35_0 main@_33_0) (= main@%.1.i_1 main@%.1.i_0))
                main@_35_0)))
  (=> a!2 (main@_35 main@%.13.i_0 main@%.1.i_1 main@%loop.bound_0)))))
(rule (=> (and (main@_35 main@%.13.i_0 main@%.1.i_0 main@%loop.bound_0)
         true
         (= main@%_36_0 (< main@%.1.i_0 main@%loop.bound_0))
         (= main@%_37_0 (+ main@%.1.i_0 1))
         (=> main@_35_1 (and main@_35_1 main@_35_0))
         (=> (and main@_35_1 main@_35_0) main@%_36_0)
         (=> (and main@_35_1 main@_35_0) (= main@%.1.i_1 main@%_37_0))
         (=> (and main@_35_1 main@_35_0) (= main@%.1.i_2 main@%.1.i_1))
         main@_35_1)
    (main@_35 main@%.13.i_0 main@%.1.i_2 main@%loop.bound_0)))
(rule (let ((a!1 (and (main@_35 main@%.13.i_0 main@%.1.i_0 main@%loop.bound_0)
                true
                (= main@%_36_0 (< main@%.1.i_0 main@%loop.bound_0))
                (= main@%_37_0 (+ main@%.1.i_0 1))
                (=> main@verifier.error_0
                    (and main@verifier.error_0 main@_35_0))
                (=> (and main@verifier.error_0 main@_35_0) (not main@%_36_0))
                (=> main@verifier.error_0
                    (= main@%_38_0 (= main@%.13.i_0 main@%.1.i_0)))
