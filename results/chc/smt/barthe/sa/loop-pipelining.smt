(set-info :original "./results/chc/bytecode/barthe/sa/loop-pipelining.bc")
...
(rule (=> (and (main@entry main@%sm20_0
                     ...
                     main@%sm25_0)
         true
         (= main@%sm_0 main@%sm25_0)
         (= main@%sm3_0 main@%sm20_0)
         (= main@%sm4_0 main@%sm21_0)
         (= main@%sm5_0 main@%sm22_0)
         (= main@%sm6_0 main@%sm23_0)
         (= main@%sm7_0 main@%sm24_0)
