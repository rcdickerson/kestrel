(set-info :original "./results/chc/bytecode/barthe/sa/loop-unswitching.bc")
...
(declare-rel main@.preheader1 (Int Int (Array Int Int) Int (Array Int Int) Int ))
...
(rule (let ((a!1 (and (main@.preheader2 @b_1_0
                                  ...
                                  main@%sm_0)
                true
                (= main@%_11_0 (+ @b_2_0 (* 0 40) (* main@%.01.i4_0 4)))
                (or (<= @b_2_0 0) (> main@%_11_0 0))
                (> @b_2_0 0)
                (= main@%sm4_0 (store main@%shadow.mem.4.0_0 main@%_11_0 0))
...
(rule (let ((a!1 (and (main@.preheader1 @b_1_0
                                  ...
                                  main@%loop.bound_0)
                true
                (= main@%_14_0 (+ @b_1_0 (* 0 40) (* main@%.03.i3_0 4)))
                (or (<= @b_1_0 0) (> main@%_14_0 0))
                (> @b_1_0 0)
                (= main@%sm5_0 (store main@%shadow.mem.0.0_0 main@%_14_0 0))
                (= main@%_15_0 (+ main@%.03.i3_0 1))
                (= main@%_16_0 (< main@%.03.i3_0 main@%loop.bound_0))
                (=> main@.preheader1_1
...
(rule (let ((a!1 (and (main@.preheader1 @b_1_0
                ...
                main@.preheader_0)))
  (=> a!1 (main@.preheader main@%.04.i_1 @b_1_0 main@%sm5_0 @b_2_0 main@%sm4_0))))
(rule (let ((a!1 (and (main@.preheader main@%.04.i_0
                ...
                (> @b_1_0 0)
                (= main@%_19_0 (select main@%sm5_0 main@%_18_0))
                ...
                main@.preheader_1)))
  (=> a!1 (main@.preheader main@%.04.i_2 @b_1_0 main@%sm5_0 @b_2_0 main@%sm4_0))))
(rule (let ((a!1 (and (main@.preheader main@%.04.i_0
                                 @b_1_0
                                 main@%sm5_0
                                 @b_2_0
