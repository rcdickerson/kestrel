(set-info :original "./results/chc/bytecode/barthe/sa/unroll.bc")
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@.preheader_0
                    (= main@%.not8.i_0 (> main@%.27.i.lcssa_1 main@%_1_0)))
                (=> main@.preheader_0
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_26_0 (= main@%.2.i.lcssa_1 main@%.12.i.lcssa_1)))
...
(rule (=> (and (main@.lr.ph13 main@%_3_0
                        ...
                        main@%.01.i11_0)
         true
         (= main@%_10_0 (+ main@%.03.i10_0 main@%.05.i9_0))
         (= main@%_11_0 (+ main@%.05.i9_0 1))
         (= main@%.not9.not.i_0 (< main@%.05.i9_0 main@%_1_0))
         (= main@%_12_0 (+ main@%.05.i9_0 2))
         (= main@%.16.i_0 (ite main@%.not9.not.i_0 main@%_12_0 main@%_11_0))
         (= main@%_13_0 (ite main@%.not9.not.i_0 main@%_11_0 0))
         (= main@%.14.i_0 (+ main@%_10_0 main@%_13_0))
         (= main@%_14_0 (+ main@%.0.i12_0 main@%.01.i11_0))
         (= main@%_15_0 (+ main@%.0.i12_0 1))
         (= main@%_16_0 (<= main@%.16.i_0 main@%_1_0))
         (= main@%_17_0 (< main@%.0.i12_0 main@%_3_0))
         ...
         (=> (and main@.lr.ph13_1 main@.lr.ph13_0)
             (= main@%.0.i12_1 main@%_15_0))
         (=> (and main@.lr.ph13_1 main@.lr.ph13_0)
             (= main@%.01.i11_1 main@%_14_0))
         (=> (and main@.lr.ph13_1 main@.lr.ph13_0)
...
(rule (let ((a!1 (and (main@.lr.ph13 main@%_3_0
                ...
                (= main@%_12_0 (+ main@%.05.i9_0 2))
                (= main@%.16.i_0
                   (ite main@%.not9.not.i_0 main@%_12_0 main@%_11_0))
                (= main@%_13_0 (ite main@%.not9.not.i_0 main@%_11_0 0))
                (= main@%.14.i_0 (+ main@%_10_0 main@%_13_0))
                (= main@%_14_0 (+ main@%.0.i12_0 main@%.01.i11_0))
                (= main@%_15_0 (+ main@%.0.i12_0 1))
                ...
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
                    (= main@%.01.i.lcssa_0 main@%_14_0))
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
                    (= main@%.0.i.lcssa_0 main@%_15_0))
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
                    (= main@%.05.i.lcssa_1 main@%.05.i.lcssa_0))
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
                    (= main@%.03.i.lcssa_1 main@%.03.i.lcssa_0))
...
(rule (=> (and (main@.lr.ph6 main@%_3_0
                       ...
                       main@%.27.i4_0)
         true
         (= main@%_23_0 (+ main@%.2.i5_0 main@%.27.i4_0))
         (= main@%_24_0 (+ main@%.27.i4_0 1))
         (= main@%_25_0 (< main@%.27.i4_0 main@%_1_0))
         (=> main@.lr.ph6_1 (and main@.lr.ph6_1 main@.lr.ph6_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) main@%_25_0)
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.2.i5_1 main@%_23_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.27.i4_1 main@%_24_0))
...
(rule (let ((a!1 (and (main@.lr.ph6 main@%_3_0
                ...
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.27.i.lcssa_0 main@%_24_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.2.i.lcssa_0 main@%_23_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.27.i.lcssa_1 main@%.27.i.lcssa_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.2.i.lcssa_1 main@%.2.i.lcssa_0))
...
(rule (=> (and (main@.lr.ph.split.us
           ...
           main@%_3_0)
         true
         (= main@%_21_0 (+ main@%.1.i3.us_0 main@%.12.i2.us_0))
         (= main@%_22_0 (+ main@%.1.i3.us_0 1))
         ...
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             main@%.not.not_0)
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.1.i3.us_1 main@%_22_0))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.12.i2.us_1 main@%_21_0))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
...
(rule (let ((a!1 (and (main@.lr.ph.split.us
                ...
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (not main@%.not.not_0))
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (= main@%.12.i.lcssa_0 main@%_21_0))
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (= main@%.12.i.lcssa_1 main@%.12.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_26_0 (= main@%.2.i.lcssa_0 main@%.12.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_26_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
