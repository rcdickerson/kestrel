(set-info :original "./results/chc/bytecode/barthe/unaligned/loop-alignment.bc")
...
(declare-rel main@empty.loop (Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Bool Int (Array Int Int) (Array Int Int) Int ))
(declare-rel main@_8 (Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Bool Int Int (Array Int Int) (Array Int Int) Int ))
(declare-rel main@.preheader (Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int (Array Int Int) (Array Int Int) Int Int ))
(declare-rel main@_18 (Int (Array Int Int) Int Int Int (Array Int Int) (Array Int Int) Int ))
(declare-rel main@_25 (Int Int (Array Int Int) Int (Array Int Int) ))
...
(rule (=> (and (main@_8 @d_1_0
         ...
         (= main@%_9_0 (+ main@%.0.i3_0 1))
         (= main@%_10_0 (< main@%.0.i3_0 main@%loop.bound2_0))
         (=> main@.preheader_0 (and main@.preheader_0 main@_8_0))
         (=> (and main@.preheader_0 main@_8_0) (not main@%_10_0))
         (=> (and main@.preheader_0 main@_8_0)
             (= main@%shadow.mem.0.0_0 main@%sm_0))
         (=> (and main@.preheader_0 main@_8_0)
             (= main@%shadow.mem.8.0_0 main@%sm4_0))
         (=> (and main@.preheader_0 main@_8_0) (= main@%_11_0 main@%_4_0))
         (=> (and main@.preheader_0 main@_8_0) (= main@%.01.i2_0 1))
         (=> (and main@.preheader_0 main@_8_0)
             (= main@%shadow.mem.0.0_1 main@%shadow.mem.0.0_0))
         (=> (and main@.preheader_0 main@_8_0)
             (= main@%shadow.mem.8.0_1 main@%shadow.mem.8.0_0))
         (=> (and main@.preheader_0 main@_8_0) (= main@%_11_1 main@%_11_0))
         (=> (and main@.preheader_0 main@_8_0)
             (= main@%.01.i2_1 main@%.01.i2_0))
         main@.preheader_0)
    (main@.preheader @d_1_0
                     @d_2_0
                     @b_2_0
                     main@%loop.bound_0
                     main@%sm5_0
                     ...
                     main@%_11_1
                     main@%loop.bound1_0)))
(rule (let ((a!1 (and (main@.preheader @d_1_0
                                 @d_2_0
                                 @b_2_0
                                 main@%loop.bound_0
                                 main@%sm5_0
                                 ...
                                 main@%loop.bound1_0)
                true
                (= main@%_12_0 (+ @b_1_0 (* 0 84) (* main@%.01.i2_0 4)))
                (or (<= @b_1_0 0) (> main@%_12_0 0))
                (> @b_1_0 0)
                (= main@%sm6_0 (store main@%shadow.mem.0.0_0 main@%_12_0 0))
                (= main@%_13_0 (+ @d_1_0 (* 0 84) (* main@%.01.i2_0 4)))
                (or (<= @d_1_0 0) (> main@%_13_0 0))
                (> @d_1_0 0)
                (= main@%sm7_0
                   (store main@%shadow.mem.8.0_0 main@%_13_0 main@%_11_0))
                (= main@%_14_0 (+ main@%.01.i2_0 1))
                (= main@%_15_0 (< main@%.01.i2_0 main@%loop.bound1_0))
                (=> main@.preheader_1 (and main@.preheader_1 main@.preheader_0))
                (=> (and main@.preheader_1 main@.preheader_0) main@%_15_0)
                (=> (and main@.preheader_1 main@.preheader_0)
                    (= main@%shadow.mem.0.0_1 main@%sm6_0))
                (=> (and main@.preheader_1 main@.preheader_0)
                    (= main@%shadow.mem.8.0_1 main@%sm7_0))
                (=> (and main@.preheader_1 main@.preheader_0) (= main@%_11_1 0))
                (=> (and main@.preheader_1 main@.preheader_0)
  ...
  (=> a!1
      (main@.preheader @d_1_0
                       ...
                       main@%_11_2
                       main@%loop.bound1_0))))
(rule (let ((a!1 (=> main@_16_0 (= main@%_17_0 (+ @d_2_0 (* 0 84) (* 1 4))))))
(let ((a!2 (and (main@.preheader @d_1_0
                                 @d_2_0
                                 @b_2_0
                                 main@%loop.bound_0
                                 main@%sm5_0
                ...
                (= main@%_14_0 (+ main@%.01.i2_0 1))
                (= main@%_15_0 (< main@%.01.i2_0 main@%loop.bound1_0))
                (=> main@_16_0 (and main@_16_0 main@.preheader_0))
                (=> (and main@_16_0 main@.preheader_0) (not main@%_15_0))
                a!1
                (=> main@_16_0 (or (<= @d_2_0 0) (> main@%_17_0 0)))
                (=> main@_16_0 (> @d_2_0 0))
                (=> main@_16_0
                    (= main@%sm8_0 (store main@%sm5_0 main@%_17_0 main@%_6_0)))
                (=> main@_18_0 (and main@_18_0 main@_16_0))
                (=> (and main@_18_0 main@_16_0)
                    (= main@%shadow.mem.4.0_0 main@%sm3_0))
                (=> (and main@_18_0 main@_16_0)
                    (= main@%shadow.mem.12.0_0 main@%sm8_0))
                (=> (and main@_18_0 main@_16_0) (= main@%.02.i1_0 1))
                (=> (and main@_18_0 main@_16_0)
  ...
  (=> a!2
      (main@_18 @d_1_0
                ...
                main@%loop.bound_0)))))
(rule (let ((a!1 (and (main@_18 @d_1_0
                          main@%sm7_0
                          @d_2_0
                          @b_2_0
                          main@%.02.i1_0
                          ...
                          main@%loop.bound_0)
                true
                (= main@%_19_0 (+ @b_2_0 (* 0 84) (* main@%.02.i1_0 4)))
                (or (<= @b_2_0 0) (> main@%_19_0 0))
                (> @b_2_0 0)
                (= main@%sm9_0 (store main@%shadow.mem.4.0_0 main@%_19_0 0))
                (= main@%_20_0 (+ main@%.02.i1_0 1))
                (= main@%_21_0 (+ @d_2_0 (* 0 84) (* main@%_20_0 4)))
                (or (<= @d_2_0 0) (> main@%_21_0 0))
                (> @d_2_0 0)
                (= main@%sm10_0 (store main@%shadow.mem.12.0_0 main@%_21_0 0))
                (= main@%_22_0 (< main@%.02.i1_0 main@%loop.bound_0))
                (=> main@_18_1 (and main@_18_1 main@_18_0))
                (=> (and main@_18_1 main@_18_0) main@%_22_0)
                (=> (and main@_18_1 main@_18_0)
                    (= main@%shadow.mem.4.0_1 main@%sm9_0))
                (=> (and main@_18_1 main@_18_0)
                    (= main@%shadow.mem.12.0_1 main@%sm10_0))
                (=> (and main@_18_1 main@_18_0) (= main@%.02.i1_1 main@%_20_0))
                (=> (and main@_18_1 main@_18_0)
  ...
  (=> a!1
      (main@_18 @d_1_0
                ...
                main@%loop.bound_0))))
(rule (let ((a!1 (= main@%_19_0 (+ (+ @b_2_0 (* 0 84)) (* main@%.02.i1_0 4))))
      (a!2 (= main@%_24_0 (+ (+ @b_2_0 (* 0 84)) (* 20 4)))))
(let ((a!3 (and (main@_18 @d_1_0
                          main@%sm7_0
                          @d_2_0
                          @b_2_0
                          main@%.02.i1_0
                ...
                (= main@%sm10_0 (store main@%shadow.mem.12.0_0 main@%_21_0 0))
                (= main@%_22_0 (< main@%.02.i1_0 main@%loop.bound_0))
                (=> main@_23_0 (and main@_23_0 main@_18_0))
                (=> (and main@_23_0 main@_18_0) (not main@%_22_0))
                (=> main@_23_0 a!2)
                (=> main@_23_0 (or (<= @b_2_0 0) (> main@%_24_0 0)))
                (=> main@_23_0 (> @b_2_0 0))
                (=> main@_23_0
                    (= main@%sm11_0 (store main@%sm9_0 main@%_24_0 0)))
                (=> main@_25_0 (and main@_25_0 main@_23_0))
                (=> (and main@_25_0 main@_23_0) (= main@%.03.i_0 1))
                (=> (and main@_25_0 main@_23_0) (= main@%.03.i_1 main@%.03.i_0))
                main@_25_0)))
  (=> a!3 (main@_25 main@%.03.i_1 @d_1_0 main@%sm7_0 @d_2_0 main@%sm10_0)))))
(rule (let ((a!1 (and (main@_25 main@%.03.i_0 @d_1_0 main@%sm7_0 @d_2_0 main@%sm10_0)
                true
                ...
                (> @d_1_0 0)
                (= main@%_28_0 (select main@%sm7_0 main@%_27_0))
                (= main@%_29_0 (+ @d_2_0 (* 0 84) (* main@%.03.i_0 4)))
                (or (<= @d_2_0 0) (> main@%_29_0 0))
                (> @d_2_0 0)
                (= main@%_30_0 (select main@%sm10_0 main@%_29_0))
                (= main@%_31_0 (= main@%_28_0 main@%_30_0))
                (= main@%_32_0 (+ main@%.03.i_0 1))
                (=> main@_25_1 (and main@_25_1 main@_25_0))
                (=> (and main@_25_1 main@_25_0) main@%_31_0)
                (=> (and main@_25_1 main@_25_0) (= main@%.03.i_1 main@%_32_0))
                (=> (and main@_25_1 main@_25_0) (= main@%.03.i_2 main@%.03.i_1))
                main@_25_1)))
  (=> a!1 (main@_25 main@%.03.i_2 @d_1_0 main@%sm7_0 @d_2_0 main@%sm10_0))))
(rule (let ((a!1 (and (main@_25 main@%.03.i_0 @d_1_0 main@%sm7_0 @d_2_0 main@%sm10_0)
                true
                (= main@%_26_0 (< main@%.03.i_0 20))
                main@%_26_0
                ...
                (=> main@verifier.error_0
                    (and main@verifier.error_0 main@_25_0))
                (=> (and main@verifier.error_0 main@_25_0) (not main@%_31_0))
