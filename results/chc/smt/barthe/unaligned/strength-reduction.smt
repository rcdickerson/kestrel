(set-info :original "./results/chc/bytecode/barthe/unaligned/strength-reduction.bc")
(set-info :authors "SeaHorn v.14.0.0-rc0")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry (Int ))
(declare-rel main@.lr.ph6 (Int Int Int Int Int Int Int Int Int ))
...
(declare-var main@%.04.i1_2 Int )
(declare-var main@%_26_0 Int )
(declare-var main@%_27_0 Int )
(declare-var main@%_30_0 Bool )
(declare-var main@%_24_0 Bool )
(declare-var main@%.02.i5_2 Int )
(declare-var main@%.03.i4_2 Int )
...
(declare-var main@%.02.i5_0 Int )
(declare-var main@%.03.i4_0 Int )
(declare-var main@%.02.i5_1 Int )
(declare-var main@%.03.i4_1 Int )
...
(declare-var main@%.04.i1_0 Int )
(declare-var main@%.0.i3_1 Int )
(declare-var main@%.01.i2_1 Int )
(declare-var main@%.04.i1_1 Int )
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@.lr.ph6_0 (and main@.lr.ph6_0 main@_22_0))
                (=> (and main@.lr.ph6_0 main@_22_0) main@%_24_0)
                (=> (and main@.lr.ph6_0 main@_22_0)
                    (= main@%.02.i5_0 main@%_7_0))
                (=> (and main@.lr.ph6_0 main@_22_0) (= main@%.03.i4_0 0))
                (=> (and main@.lr.ph6_0 main@_22_0)
                    (= main@%.02.i5_1 main@%.02.i5_0))
                (=> (and main@.lr.ph6_0 main@_22_0)
                    (= main@%.03.i4_1 main@%.03.i4_0))
                main@.lr.ph6_0)))
  (=> a!1
      (main@.lr.ph6 main@%_9_0
                    main@%_13_0
                    main@%_11_0
                    main@%_15_0
                    main@%.03.i4_1
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@_22_0 main@%_23_2)
                (=> main@_22_0 (= main@%_24_0 (> main@%_5_0 0)))
                (=> main@.preheader_0 (and main@.preheader_0 main@_22_0))
                (=> (and main@.preheader_0 main@_22_0) (not main@%_24_0))
                (=> (and main@.preheader_0 main@_22_0)
                    (= main@%.02.i.lcssa_0 main@%_7_0))
                (=> (and main@.preheader_0 main@_22_0)
                    (= main@%.02.i.lcssa_1 main@%.02.i.lcssa_0))
                (=> main@.preheader_0 (= main@%_25_0 (> main@%_13_0 0)))
                ...
                (=> (and main@.lr.ph_0 main@.preheader_0)
                    (= main@%.0.i3_0 main@%_11_0))
                (=> (and main@.lr.ph_0 main@.preheader_0) (= main@%.01.i2_0 0))
                (=> (and main@.lr.ph_0 main@.preheader_0)
                    (= main@%.04.i1_0 main@%_15_0))
                (=> (and main@.lr.ph_0 main@.preheader_0)
                    (= main@%.0.i3_1 main@%.0.i3_0))
                (=> (and main@.lr.ph_0 main@.preheader_0)
                    (= main@%.01.i2_1 main@%.01.i2_0))
                (=> (and main@.lr.ph_0 main@.preheader_0)
                    (= main@%.04.i1_1 main@%.04.i1_0))
                main@.lr.ph_0)))
  (=> a!1
      (main@.lr.ph main@%.02.i.lcssa_1
                   main@%.0.i3_1
                   main@%.04.i1_1
                   main@%_9_0
                   main@%.01.i2_1
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> (and main@verifier.error_0 main@.preheader_0)
                    (not main@%_25_0))
                (=> (and main@verifier.error_0 main@.preheader_0)
                    (= main@%.04.i.lcssa_0 main@%_15_0))
                (=> (and main@verifier.error_0 main@.preheader_0)
                    (= main@%.04.i.lcssa_1 main@%.04.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_35_0 (= main@%.02.i.lcssa_1 main@%.04.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_35_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
  (=> a!1 main@verifier.error.split)))
(rule (=> (and (main@.lr.ph6 main@%_9_0
                       main@%_13_0
                       main@%_11_0
                       main@%_15_0
                       main@%.03.i4_0
                       ...
                       main@%_5_0)
         true
         (= main@%_27_0 (+ main@%_26_0 main@%_3_0))
         (= main@%_28_0 (+ main@%_27_0 main@%.02.i5_0))
         (= main@%_29_0 (+ main@%.03.i4_0 1))
         (= main@%_30_0 (< main@%_29_0 main@%_5_0))
         (=> main@.lr.ph6_1 (and main@.lr.ph6_1 main@.lr.ph6_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) main@%_30_0)
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.02.i5_1 main@%_28_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.03.i4_1 main@%_29_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0)
             (= main@%.02.i5_2 main@%.02.i5_1))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0)
    ...
    (main@.lr.ph6 main@%_9_0
                  ...
                  main@%.02.i5_2
                  main@%_5_0)))
(rule (let ((a!1 (and (main@.lr.ph6 main@%_9_0
                              main@%_13_0
                              main@%_11_0
                              main@%_15_0
                              main@%.03.i4_0
...
(rule (=> (and (main@.lr.ph main@%.02.i.lcssa_0
                      ...
                      main@%_13_0)
         true
         (= main@%_31_0 (+ main@%.0.i3_0 main@%.04.i1_0))
         (= main@%_32_0 (+ main@%.0.i3_0 main@%_9_0))
         (= main@%_33_0 (+ main@%.01.i2_0 1))
         (= main@%_34_0 (< main@%_33_0 main@%_13_0))
         (=> main@.lr.ph_1 (and main@.lr.ph_1 main@.lr.ph_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) main@%_34_0)
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%.0.i3_1 main@%_32_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%.01.i2_1 main@%_33_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%.04.i1_1 main@%_31_0))
...
(rule (let ((a!1 (and (main@.lr.ph main@%.02.i.lcssa_0
                ...
                (=> (and main@verifier.error_0 main@.lr.ph_0) (not main@%_34_0))
                (=> (and main@verifier.error_0 main@.lr.ph_0)
                    (= main@%.04.i.lcssa_0 main@%_31_0))
                (=> (and main@verifier.error_0 main@.lr.ph_0)
                    (= main@%.04.i.lcssa_1 main@%.04.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_35_0 (= main@%.02.i.lcssa_0 main@%.04.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_35_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
