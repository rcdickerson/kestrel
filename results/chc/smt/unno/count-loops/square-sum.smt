(set-info :original "./results/chc/bytecode/unno/count-loops/square-sum.bc")
...
(declare-var main@%.25.i2.us_2 Int )
...
(declare-var main@%.25.i2.us_0 Int )
(declare-var main@%.2.i3.us_1 Int )
(declare-var main@%.25.i2.us_1 Int )
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@.preheader_0
                    (= main@%_30_0 (>= main@%.1.i.lcssa_1 main@%_3_0)))
                (=> main@.preheader_0
                    (= main@%_31_0 (< main@%.03.i.lcssa_1 main@%_7_0)))
                (=> main@.preheader_0
                    (= main@%_32_0 (ite main@%_30_0 main@%_31_0 false)))
                (=> main@.lr.ph.split.us_0
                    (and main@.lr.ph.split.us_0 main@.preheader_0))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0) main@%_32_0)
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.2.i3.us_0 main@%.01.i.lcssa_1))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.25.i2.us_0 main@%.03.i.lcssa_1))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.2.i3.us_1 main@%.2.i3.us_0))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.25.i2.us_1 main@%.25.i2.us_0))
                main@.lr.ph.split.us_0)))
  (=> a!1
      (main@.lr.ph.split.us
        main@%.17.i.lcssa_1
...
(rule (let ((a!1 (and (main@entry @arb_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_41_0 (= main@%.17.i.lcssa_1 main@%.2.i.lcssa_1)))
...
(rule (=> (and (main@.lr.ph13 main@%_7_0
                        ...
                        main@%.01.i11_0)
         true
         (= main@%_18_0 (+ main@%_17_0 main@%.06.i9_0))
         (= main@%_19_0 (+ main@%.0.i12_0 1))
         (= main@%_21_0 (+ main@%.01.i11_0 main@%_20_0))
         (= main@%_22_0 (+ main@%.03.i10_0 1))
         (= main@%_23_0 (< main@%_22_0 main@%_7_0))
         (= main@%_25_0 (+ main@%.03.i10_0 2))
         (= main@%.14.i_0 (ite main@%_23_0 main@%_25_0 main@%_22_0))
         (= main@%_26_0 (ite main@%_23_0 main@%_24_0 0))
         (= main@%.12.i_0 (+ main@%_21_0 main@%_26_0))
         (= main@%_27_0 (< main@%_19_0 main@%_3_0))
         (= main@%_28_0 (< main@%.14.i_0 main@%_7_0))
         (= main@%_29_0 (ite main@%_27_0 main@%_28_0 false))
         (=> main@.lr.ph13_1 (and main@.lr.ph13_1 main@.lr.ph13_0))
         (=> (and main@.lr.ph13_1 main@.lr.ph13_0) main@%_29_0)
...
(rule (let ((a!1 (and (main@.lr.ph13 main@%_7_0
                ...
                (=> (and main@.preheader1_0 main@.lr.ph13_0) (not main@%_29_0))
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
                    (= main@%.06.i.lcssa_0 main@%_18_0))
                (=> (and main@.preheader1_0 main@.lr.ph13_0)
...
(rule (=> (and (main@.lr.ph6 main@%_7_0
                       ...
                       main@%.17.i4_0)
         true
         (= main@%_38_0 (+ main@%_37_0 main@%.17.i4_0))
         (= main@%_39_0 (+ main@%.1.i5_0 1))
         (= main@%_40_0 (< main@%_39_0 main@%_3_0))
         (=> main@.lr.ph6_1 (and main@.lr.ph6_1 main@.lr.ph6_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) main@%_40_0)
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.1.i5_1 main@%_39_0))
         (=> (and main@.lr.ph6_1 main@.lr.ph6_0) (= main@%.17.i4_1 main@%_38_0))
...
(rule (let ((a!1 (and (main@.lr.ph6 main@%_7_0
                ...
                (=> (and main@.preheader_0 main@.lr.ph6_0) (not main@%_40_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.17.i.lcssa_0 main@%_38_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.1.i.lcssa_0 main@%_39_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.17.i.lcssa_1 main@%.17.i.lcssa_0))
                (=> (and main@.preheader_0 main@.lr.ph6_0)
                    (= main@%.1.i.lcssa_1 main@%.1.i.lcssa_0))
                (=> main@.preheader_0
                    (= main@%_30_0 (>= main@%.1.i.lcssa_1 main@%_3_0)))
                (=> main@.preheader_0
                    (= main@%_31_0 (< main@%.03.i.lcssa_0 main@%_7_0)))
                (=> main@.preheader_0
                    (= main@%_32_0 (ite main@%_30_0 main@%_31_0 false)))
                (=> main@.lr.ph.split.us_0
                    (and main@.lr.ph.split.us_0 main@.preheader_0))
                ...
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.25.i2.us_0 main@%.03.i.lcssa_0))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.2.i3.us_1 main@%.2.i3.us_0))
                (=> (and main@.lr.ph.split.us_0 main@.preheader_0)
                    (= main@%.25.i2.us_1 main@%.25.i2.us_0))
...
(rule (=> (and (main@.lr.ph.split.us
           ...
           main@%_7_0)
         true
         (= main@%_34_0 (+ main@%.2.i3.us_0 main@%_33_0))
         (= main@%_35_0 (+ main@%.25.i2.us_0 1))
         (= main@%_36_0 (< main@%_35_0 main@%_7_0))
         (=> main@.lr.ph.split.us_1
             (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0) main@%_36_0)
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.2.i3.us_1 main@%_34_0))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.25.i2.us_1 main@%_35_0))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.2.i3.us_2 main@%.2.i3.us_1))
         (=> (and main@.lr.ph.split.us_1 main@.lr.ph.split.us_0)
             (= main@%.25.i2.us_2 main@%.25.i2.us_1))
         main@.lr.ph.split.us_1)
    (main@.lr.ph.split.us
      main@%.17.i.lcssa_0
      main@%.25.i2.us_2
...
(rule (let ((a!1 (and (main@.lr.ph.split.us
                ...
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (not main@%_36_0))
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (= main@%.2.i.lcssa_0 main@%_34_0))
                (=> (and main@verifier.error_0 main@.lr.ph.split.us_0)
                    (= main@%.2.i.lcssa_1 main@%.2.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_41_0 (= main@%.17.i.lcssa_0 main@%.2.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_41_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
