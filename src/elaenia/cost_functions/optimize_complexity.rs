...
pub struct ElaeniaOptimizeStructureCost {
...
impl PartialOrd for ElaeniaOptimizeStructureCost {
...
/// [Eggroll] programs.
pub struct ElaeniaOptimizeStructureCostFunction;
impl CostFunction<Eggroll> for ElaeniaOptimizeStructureCostFunction {
    type Cost = ElaeniaOptimizeStructureCost;
    ...
    C: FnMut(Id) -> Self::Cost
  {
    ...
    ElaeniaOptimizeStructureCost{num_loops, cond_paths, num_relations, ast_size, is_cond}
  }
}
